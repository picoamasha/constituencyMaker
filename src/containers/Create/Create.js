            ...
            <div className = "float-container">
              <div className = "float-child map">
                ...
                <map name="image-map">
                    ...
                    <area class="noborder icolor00ff00" target="" onClick={()=>this.filterTableData("Dimapur Sadar")} alt="Dimapur Sadar" title="Dimapur Sadar" coords="162,346,171,338,178,339,184,332,189,334,196,331,201,331,207,328,209,321,218,322,215,332,213,338,216,350,208,348,211,356,200,363,195,371,190,379,187,392,180,390" shape="poly"/>
